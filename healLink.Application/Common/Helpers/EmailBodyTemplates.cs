...
namespace HealLink.Application.Common.Helpers
{
    public static class EmailBodyTemplates
    {
        ...
        private static string EmailConfirmationTemplate(string name, string token)
        {
            ...
            <div style=""font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:20px;border:1px solid #eee;border-radius:10px;"">
                <h2 style=""color:#2c3e50;"">Welcome to HealLink 👋</h2>
                
                <p style=""font-size:16px;"">Hello <strong>{name}</strong>,</p>
                
                <p style=""font-size:15px;"">Thanks for registering at <strong>HealLink</strong>.</p>
